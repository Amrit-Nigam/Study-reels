  ...
  return (
    <div className="relative">
        ...
        <div className="bg-black/10 backdrop-blur-md border-b border-white/10">
          <div className="container max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
            <div className="flex items-center gap-2">
              <h2 className="text-2xl font-bold bg-gradient-to-r from-white/90 via-purple-200/90 to-blue-200/90 bg-clip-text text-transparent">
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <div className="container max-w-6xl px-4 pt-32 pb-16 text-center flex-1">
          <div className="mb-16">
            <motion.div 
            ...
            <motion.h1 
              className="text-7xl md:text-8xl font-bold relative z-20 flex justify-center items-center gap-2 mb-6"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
        ...
        {/* Footer */}
        <footer className="w-full py-12 relative z-10 mt-auto border-t border-white/10">
